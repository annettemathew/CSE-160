...
class Vector3 {
  ...
  //     // Insert your code here.
  //     let d = this.magnitude(); // Modify this line to calculate this vector's magnitude.
  //     for (let i = 0; i < 3; ++i) {            
  //         this.elements[i] *= other2.elements[i];
  //         console.log("current dimension product: ", this.elements[i]);
  //         d += this.elements[i]
  //     }
  //     // Don't delete the return statement.
  //     return d;
  ...
  static dot(other1, other2) {
      let d = 0;
      for (let i = 0; i < 3; ++i) {
          //console.log(`Dimension other 1 ${i}: ${other1.elements[i]}`);
          //console.log(`Dimension other 2 ${i}: ${other2.elements[i]}`);
  ...
  normalize() {
      ...
      for (let i = 0; i < 3; ++i) {
          this.elements[i] /= mag;
          //console.log("Normalized: ", i, " ", this.elements[i]);
      }
      // Don't delete the return statement.
      return this;
  };
